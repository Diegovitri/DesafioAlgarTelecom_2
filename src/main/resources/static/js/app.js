...
var appFuncionario = angular.module("appFuncionario",[]);

appFuncionario.controller("indexController", function ($scope,$http){
	...
	$scope.salvarFuncionario= function(){
		$http({method:'POST',url:'http://localhost:8080/insereFuncionario', data:$scope.funcionario})
		.then(function (response){
			$scope.funcionarios=response.data;
			$scope.carregarFuncionarios();
		}, function (response){
	...
	$scope.excluirFuncionario= function(funcionario){
		$http({method:'DELETE',url:'http://localhost:8080/deleteFuncionario?codigo='+funcionario.cod_funcionario})
		.then(function (response){
			$scope.funcionarios=response.data;
			$scope.carregarFuncionarios();
		}, function (response){
	...
	/*	$http({method:'POST',url:'http://localhost:8080/editarFuncionario?codigo='+funcionario.cod_funcionario})
		.then(function (response){
			$scope.funcionarios=response.data;
			$scope.carregarFuncionarios();
		}, function (response){
